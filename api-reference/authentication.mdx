...
The BotRep.ai API uses API keys to authenticate requests. You need to include your API key in the header of each request you make to the API.

## Obtaining an API Key

To obtain an API key:

1. Log in to your BotRep.ai account at [https://app.botrep.ai](https://app.botrep.ai)
...
```bash
curl -X GET "https://app.botrep.ai/api/user/campaigns" \
