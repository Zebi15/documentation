...
<AccordionGroup>
  ...
  <Accordion title="Webhook URL" icon="link">
    ...
    **Example:** `https://app.botrep.ai/automate/api/v1/webhooks/your-webhook-id`
...
```json
{
  ...
  "transcript": [
    {
      "text": "Hello! This is Sarah from BotRep.ai.",
      "type": "transcript",
      "sender": "bot",
  ...
  "formatted_transcript": "AI: Hello! This is Sarah from BotRep.ai.\\nCustomer: Hi, I'm doing well, thanks.",
  "recording_url": "https://app.botrep.ai/storage/recordings/call-12345.mp4",
