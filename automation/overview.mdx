...
description: "Learn about BotRep.ai's built-in automation engine for creating workflows without coding"
---
...
BotRep.ai includes an internal automation engine (similar to Zapier or Make) that lets you build flows—no coding required. For instance:
...
- **Triggers**: Events inside BotRep.ai (e.g., "call ended," "inbound call context injection").
