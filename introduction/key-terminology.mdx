...
icon: "book"
description: "Essential terms and concepts you need to know to use BotRep.ai effectively"
---

Understanding these terms will help you navigate BotRep.ai more easily:
...
BotRep.ai's built-in workflow platform, similar to Zapier/Make. It lets you connect triggers (like "call ended") to actions (like "send an email" or "update a Google Sheet") without writing code.
...
A method to connect your existing phone system or VOIP provider with BotRep.ai without renting new numbers.
